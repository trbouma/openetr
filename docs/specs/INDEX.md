...
- [PROVENANCE_AND_CONTROL_DESIGN_NOTE.md](./PROVENANCE_AND_CONTROL_DESIGN_NOTE.md)
- [CONSEQUENTIAL_STATE_ARCHITECTURE_DESIGN_NOTE.md](./CONSEQUENTIAL_STATE_ARCHITECTURE_DESIGN_NOTE.md)
- [DIGITAL_CONTROLLABLE_RECORD_DESIGN_NOTE.md](./DIGITAL_CONTROLLABLE_RECORD_DESIGN_NOTE.md)
- [DIGITAL_ORIGINALITY_CONTROL_AND_STANDING_DESIGN_NOTE.md](./DIGITAL_ORIGINALITY_CONTROL_AND_STANDING_DESIGN_NOTE.md)
- [RECORDS_FIRST_AUTHENTICITY_AND_DIGITAL_ORIGINALITY_DESIGN_NOTE.md](./RECORDS_FIRST_AUTHENTICITY_AND_DIGITAL_ORIGINALITY_DESIGN_NOTE.md)
- [OPENETR_KEY_TRANSPARENCY_LESSONS_DESIGN_NOTE.md](./OPENETR_KEY_TRANSPARENCY_LESSONS_DESIGN_NOTE.md)
- [OPENETR_AND_C2PA_DESIGN_NOTE.md](./OPENETR_AND_C2PA_DESIGN_NOTE.md)
- [OPENETR_DEPENDENCY_INTEGRITY_DESIGN_NOTE.md](./OPENETR_DEPENDENCY_INTEGRITY_DESIGN_NOTE.md)
- [OPENETR_ORGANIZATIONAL_REFERENCE_LAYER_DESIGN_NOTE.md](./OPENETR_ORGANIZATIONAL_REFERENCE_LAYER_DESIGN_NOTE.md)
- [OPENETR_AND_OPEN_TRUST_LAYER_REVIEW_NOTE.md](./OPENETR_AND_OPEN_TRUST_LAYER_REVIEW_NOTE.md)
- [OPENETR_AUTONOMOUS_SYSTEMS_GOVERNANCE_REVIEW_NOTE.md](./OPENETR_AUTONOMOUS_SYSTEMS_GOVERNANCE_REVIEW_NOTE.md)
- [OPENETR_AND_SPHERITY_M_TRUST_ANALYSIS_NOTE.md](./OPENETR_AND_SPHERITY_M_TRUST_ANALYSIS_NOTE.md)
- [OPENETR_MLETR_ETDA_MAPPING_DESIGN_NOTE.md](./OPENETR_MLETR_ETDA_MAPPING_DESIGN_NOTE.md)
- [OPENETR_GLOBAL_ETR_USE_CASES_REVIEW_NOTE.md](./OPENETR_GLOBAL_ETR_USE_CASES_REVIEW_NOTE.md)
- [OPENETR_GENERIC_DOMAIN_ADAPTER_SPEC.md](./OPENETR_GENERIC_DOMAIN_ADAPTER_SPEC.md)
- [OPENETR_MARKS_AND_ARCS_DOMAIN_ADAPTER_DESIGN_NOTE.md](./OPENETR_MARKS_AND_ARCS_DOMAIN_ADAPTER_DESIGN_NOTE.md)
- [OPENETR_EBL_DOMAIN_ADAPTER_DESIGN_NOTE.md](./OPENETR_EBL_DOMAIN_ADAPTER_DESIGN_NOTE.md)
- [APOSTILLE_DOCUMENTS_DOMAIN_ADAPTER_SPEC.md](./APOSTILLE_DOCUMENTS_DOMAIN_ADAPTER_SPEC.md)
...
- [OPENETR_CONTROL_GRAPH_INFOGRAPHIC.md](./OPENETR_CONTROL_GRAPH_INFOGRAPHIC.md)
- [OPENETR_AND_TRADETRUST_COMPARISON.md](./OPENETR_AND_TRADETRUST_COMPARISON.md)
...
- [ZK_SNARKS_AND_HASH_COMMITMENTS_DESIGN_NOTE.md](./ZK_SNARKS_AND_HASH_COMMITMENTS_DESIGN_NOTE.md)
...
- [OPENETR_DIDS_NOSTR_AND_DID_WEBVH_ANALYSIS_NOTE.md](./OPENETR_DIDS_NOSTR_AND_DID_WEBVH_ANALYSIS_NOTE.md)
- [OPENETR_AND_MANAGING_DIGITAL_IDENTITY_REVIEW_NOTE.md](./OPENETR_AND_MANAGING_DIGITAL_IDENTITY_REVIEW_NOTE.md)
- [IDENTIFIER_RESOLUTION_RULES.md](./IDENTIFIER_RESOLUTION_RULES.md)
...
- [MLWR_WAREHOUSE_RECEIPT_PILOT_BOUNDARY_NOTES.md](./MLWR_WAREHOUSE_RECEIPT_PILOT_BOUNDARY_NOTES.md)
- [MLWR_WAREHOUSE_OPERATOR_ISSUANCE_USE_CASE.md](./MLWR_WAREHOUSE_OPERATOR_ISSUANCE_USE_CASE.md)
- [MLWR_ARTICLE_REQUIREMENTS_MAPPING.md](./MLWR_ARTICLE_REQUIREMENTS_MAPPING.md)
- [DIGITAL_PRODUCT_PASSPORT_REQUIREMENTS_MAPPING.md](./DIGITAL_PRODUCT_PASSPORT_REQUIREMENTS_MAPPING.md)
- [EU_DIGITAL_PRODUCT_PASSPORT_REGULATORY_ANALYSIS_NOTE.md](./EU_DIGITAL_PRODUCT_PASSPORT_REGULATORY_ANALYSIS_NOTE.md)
...
- [TITLE_TRANSFER_AUTHORITY_REPLACEABLE_EVENT_SPEC.md](./TITLE_TRANSFER_AUTHORITY_REPLACEABLE_EVENT_SPEC.md) (legacy / specialized recognition pattern)
- [TITLE_TRANSFER_AUTHORITY_TRUST_ASSUMPTIONS.md](./TITLE_TRANSFER_AUTHORITY_TRUST_ASSUMPTIONS.md) (legacy / specialized recognition pattern)
